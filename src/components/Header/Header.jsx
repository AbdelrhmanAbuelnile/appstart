...
function Header() {
  return (
    <header className="bg-primary w-full py-4 px-4 lg:px-28 fixed flex flex-row justify-between items-center z-10">
      <a
      ...
      <nav>
        ...
        <ul className="hidden  lg:flex lg:flex-row justify-center items-center gap-8 text-xl text-third font-medium">
          ...
          <li>
            <a className="hover:text-white duration-150" href="#portfolio">
              Portfolio
            </a>
          </li>
          <li>
            <a href="#sevices" className="hover:text-white duration-150">
              Services
            </a>
          </li>
        </ul>
